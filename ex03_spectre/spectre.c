...
char leak_byte(int offset) {
  for (size_t i = 0; i < 300; i++) {
    ...
    // =========================
    // TODO: prepare the channel


    // =========================
    // Step 2: Mistrain Branch
    // =========================
    // TODO: mistrain the branch of 'access_api()'
    ...
    fence();
    // TODO: time for calling 'access_api()' and exploit spectre 

    // ===================
    // Step 4: Leak Data
    // ===================
    // TODO: decode the result from the channel
    //  HINT: Use the function 'get_permuted_index()' to prevent the prefetcher from interferring
  }
  return -1;
}
